...
$settings = array(
	...
	'order_payment_complete_delay'         => array(
		...
		'type'    => 'number',
		'description'   => __( 'Set the delay time, in minutes, between when the order is placed and when it is confirmed and set to Processing in WooCommerce. This delay can be useful if you have integrations that may modify the order shortly after it\'s created, and you want those changes to be included in emails or synchronized to external systems.', 'collector-checkout-for-woocommerce' ),
		'default' => '1',
