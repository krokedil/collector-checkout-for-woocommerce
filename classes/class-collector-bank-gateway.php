...
class Collector_Bank_Gateway extends WC_Payment_Gateway {
	...
	public function populate_fields( $value, $key ) {
		...
		$billing_first_name = $customer_data->customer->billigAddress->firstName;
		$billing_last_name  = $customer_data->customer->billigAddress->lastName;
		$billing_country    = $customer_data->customer->billigAddress->country;
		$billing_address    = $customer_data->customer->billigAddress->address;
		$billing_city       = $customer_data->customer->billigAddress->city;
		$billing_postcode   = $customer_data->customer->billigAddress->postalCode;

		// Get shipping information from the customer
		$shipping_first_name = $customer_data->customer->billigAddress->firstName;
		$shipping_last_name  = $customer_data->customer->billigAddress->lastName;
		$shipping_country    = $customer_data->customer->billigAddress->country;
		$shipping_address    = $customer_data->customer->billigAddress->address;
		$shipping_city       = $customer_data->customer->billigAddress->city;
		$shipping_postcode   = $customer_data->customer->billigAddress->postalCode;

		// Standard information
		$phone = $customer_data->customer->mobilePhoneNumber;
