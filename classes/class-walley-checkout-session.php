...
class Walley_Checkout_Session {
	...
	public static function get_customer_address( $walley_order ) {
		...
		if ( 'BusinessCustomer' === $walley_order['data']['customerType'] ) {
			...
			$customer_address['billing_address_2']  = $walley_order['data']['businessCustomer']['invoiceAddress']['address2'] ?? '';
			$customer_address['billing_postcode']   = $walley_order['data']['businessCustomer']['invoiceAddress']['postalCode'] ?? '';
			$customer_address['billing_country']    = $walley_order['data']['businessCustomer']['invoiceAddress']['countryCode'] ?? '';
			$customer_address['billing_address_co'] = $walley_order['data']['businessCustomer']['invoiceAddress']['coAddress'] ?? '';
			...
			$customer_address['shipping_address_2']  = $walley_order['data']['businessCustomer']['deliveryAddress']['address2'] ?? '';
			$customer_address['shipping_postcode']   = $walley_order['data']['businessCustomer']['deliveryAddress']['postalCode'] ?? '';
			$customer_address['shipping_country']    = $walley_order['data']['businessCustomer']['deliveryAddress']['countryCode'] ?? '';
			$customer_address['shipping_address_co'] = $walley_order['data']['businessCustomer']['deliveryAddress']['coAddress'] ?? '';
			...
			$customer_address['billing_address_2']  = $walley_order['data']['customer']['billingAddress']['address2'] ?? '';
			$customer_address['billing_postcode']   = $walley_order['data']['customer']['billingAddress']['postalCode'] ?? '';
			$customer_address['billing_country']    = $walley_order['data']['customer']['billingAddress']['countryCode'] ?? '';
			$customer_address['billing_address_co'] = $walley_order['data']['customer']['billingAddress']['coAddress'] ?? '';
			...
			$customer_address['shipping_address_2']  = $walley_order['data']['customer']['deliveryAddress']['address2'] ?? '';
			$customer_address['shipping_postcode']   = $walley_order['data']['customer']['deliveryAddress']['postalCode'] ?? '';
			$customer_address['shipping_country']    = $walley_order['data']['customer']['deliveryAddress']['countryCode'] ?? '';
			$customer_address['shipping_address_co'] = $walley_order['data']['customer']['deliveryAddress']['coAddress'] ?? '';
